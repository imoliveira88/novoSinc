...
from aplicacao.views import testa_envio, logout_view, testa_envio_proximas, testa_envio_vencidas, proximas_a_vencer, vencidas, status, historico_logins, modelos, home

handler404 = custom_404

urlpatterns = [
    path('aplicacao/', home, name="home"),
    ...
    path('aplicacao/teste_envio_proximas', testa_envio_proximas, name="teste_envio_proximas"),
    path('aplicacao/teste_envio_vencidas', testa_envio_vencidas, name="teste_envio_vencidas"),
